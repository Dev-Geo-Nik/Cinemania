			...
			<div className={styles.person_container}>
				...
				<div className={styles.header}>
					...
					<div className={styles.text_content}>
						...
						{/* !!!Todo change them with small images. */}
						<div className={styles.socials_container}>
							{facebook_id ? (
								<a href={`https://www.facebook.com/${facebook_id}`} target="_blank">
									<FaFacebookSquare className={`${styles.social_icons} ${styles.facebook_icon}`} />
								</a>
							) : null}
							{instagram_id ? (
								<a href={`https://www.instagram.com/${instagram_id}`} target="_blank">
									<FaInstagramSquare className={`${styles.social_icons} ${styles.instagram_icon}`} />
								</a>
							) : null}
							{twitter_id ? (
								<a href={`https://www.twitter.com/${twitter_id}`} target="_blank">
									<FaTwitterSquare className={`${styles.social_icons} ${styles.twitter_icon}`} />
								</a>
							) : null}
						</div>
					</div>
